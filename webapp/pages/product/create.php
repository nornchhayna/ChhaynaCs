...
if (isset($_POST['name']) && isset($_POST['slug']) && isset($_POST['price']) && isset($_POST['short_des']) && isset($_POST['long_des']) && isset($_FILES['image'])) {
    ...
    if (empty($name)) {
        ...
        if (empty($price)) {
            ...
            if ($price < 0) {
                $price_err = "Price must not be than zero";
            }
        }
        if (empty($short_des)) {
            ...
            try {
                if (createProduct($name, $slug, $price, $short_des, $long_des, $image, $id_categories)) {
                    echo   '<div class="alert alert-success" role="alert">
                        ...
                        <a href="./?page=product/home">Product Page</a>
                        </div>';
...
<form action="./?page=product/create" method="post" class="w-50 mx-auto" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <textarea name="short_des"
            class="form-control <?php echo $short_des_err !== '' ? 'is-invalid' : '' ?>"><?php echo isset($_POST['short_des']) ? $_POST['short_des'] : '' ?></textarea>
        <div class="invalid-feedback">
    ...
    <div class="mb-3">
        ...
        <textarea name="long_des"
            class="form-control <?php echo $long_des_err !== '' ? 'is-invalid' : '' ?>"><?php echo isset($_POST['long_des']) ? $_POST['long_des'] : '' ?></textarea>
        <div class="invalid-feedback">
    ...
    <div class="mb-3">
        ...
        ?>
                <div class="form-check">
                    <input name="id_categories[]" class="form-check-input" type="checkbox"
